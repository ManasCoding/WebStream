...
import { MdPhoto, MdTitle, MdDescription, MdCategory, MdCloudUpload } from 'react-icons/md';
        ...
        <div className="w-full max-w-[800px] bg-[#0a0c10]/40 backdrop-blur-3xl border border-white/5 rounded-[3.5rem] p-12 md:p-20 shadow-2xl relative group overflow-hidden">
          ...
          <div className="flex flex-col items-center mb-16 text-center">
            <div className="h-16 w-16 bg-purple-600/10 rounded-3xl flex items-center justify-center mb-6 border border-purple-500/10 shadow-[0_0_30px_rgba(147,51,234,0.1)]">
              <MdPhoto className="text-3xl text-purple-500" />
            </div>
            <h1 className="text-5xl font-black mb-4 tracking-tighter uppercase">
              Refine <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-600 italic">Visual</span>
            </h1>
            <p className="text-gray-500 text-[10px] font-black uppercase tracking-[0.4em] opacity-60">Authorize modification of static media</p>
          </div>
          ...
          <form className="space-y-10">
            <div className="space-y-8">
              <div className="space-y-3">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500 ml-1 flex items-center gap-2">
                  <MdTitle className="text-purple-500" /> Visual Identity
                </label>
                <input 
                  ...
                  type="text" 
                  placeholder="The designation of this capture..." 
                  name="title" 
              ...
              <div className="space-y-3">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500 ml-1 flex items-center gap-2">
                  <MdDescription className="text-purple-500" /> Narrative Context
                </label>
                <textarea 
              ...
              <div className="space-y-3">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500 ml-1 flex items-center gap-2">
                  <MdCategory className="text-purple-500" /> Classification
                </label>
                <input 
                  className="w-full bg-white/[0.03] border border-white/5 rounded-2xl py-5 px-8 outline-none focus:border-purple-500/30 transition-all text-[14px] font-bold placeholder:text-gray-800 shadow-inner" 
                  type="text" 
                  placeholder="e.g. Abstract, Urban, High-Fidelity" 
                  name="category"
            ...
            <div className="bg-[#050608]/50 rounded-3xl p-8 border border-dashed border-white/10 flex flex-col items-center gap-6 group/upload transition-all hover:border-purple-500/30">
              <label className="cursor-pointer w-full flex flex-col items-center gap-4">
                <MdCloudUpload className="text-4xl text-gray-700 group-hover/upload:text-purple-500 transition-colors" />
                <div className="text-center">
                  <span className="text-[11px] font-black uppercase tracking-[0.2em] text-white/80">Replace Visual Asset</span>
                  <p className="text-[9px] text-gray-600 font-bold mt-1 uppercase tracking-widest">Supports ultra-clear imagery</p>
                </div>
